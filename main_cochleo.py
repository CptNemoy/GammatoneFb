...
def main(ignore_playback_warning=False, mode='rand_sound'):
  ...
  coch_pow_batches = cgram.cochleagram(signal=new_array, sr=demo_sr, n=demo_n, low_lim=50, hi_lim=demo_sr//2, sample_factor=2,
        padding_size=None, downsample=None, nonlinearity='power',
        fft_mode='auto', ret_mode='envs', strict=False)
  ...
  real_subband_signal = cgram.cochleagram(signal=demo_stim, sr=demo_sr, n=demo_n, low_lim=50, hi_lim=demo_sr//2, sample_factor=2,
        padding_size=None, downsample=None, nonlinearity=None,
        fft_mode='auto', ret_mode='subband', strict=False)

  analytic_subband_signal = cgram.cochleagram(signal=demo_stim, sr=demo_sr, n=demo_n, low_lim=50, hi_lim=demo_sr//2, sample_factor=2,
        padding_size=None, downsample=None, nonlinearity=None,
        fft_mode='auto', ret_mode='analytic', strict=False)
  ...
  print(f'size of analytic subband signal = {analytic_subband_signal.shape}, is real = {np.isrealobj(analytic_subband_signal)}')
